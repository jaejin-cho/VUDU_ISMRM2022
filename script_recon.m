...
if ~exist('data.mat','file')
    url = 'https://www.dropbox.com/s/d9su03c80vf1r89/data.mat?dl=1';
    cmd = ['curl -L -o ' 'data.mat' ' "' url '"'];
    assert(system(cmd) == 0, sprintf(['download failed: '  url '\nplease download the data manually']));
end
load('data.mat');
    ...
    for iz = 1:nz        
        ...
        for iter = 1:100
            ...
            for ir = 1:rz
                ...
                img_cat = cat(3,img_cat,conj(img_cat)); % c coil
